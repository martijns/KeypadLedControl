// KeypadLedControlSetupActions.cpp : Defines the entry point for the DLL application.
//
...
{
	// Before (un)installing, we need to shut down the existing KeypadLedControl. We'll use the Event for this which we have since the first version.
